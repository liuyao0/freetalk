...
import {UserPrivateChat} from "../component/UserPrivateChat";

const { Header, Content, Sider,Footer } = Layout;
const { SubMenu } = Menu;


export class UserPrivateChatView extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapsed: false,
            ...
            <Layout style={{ minHeight: '100vh' }}>
                <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse}>
                    ...
                    >
                        ...
                        <SubMenu key="sub2" icon={<MessageOutlined />} inlineCollapsed={false} title="通知">
                ...
                <Layout className="site-layout" stytle={{backgroundColor:'white'}}>
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                            <UserPrivateChat myUserId={this.state.userId}/>
                        </div>
                    </Content>
