...
import RecommendTopics from "../component/RecommendTopics";

const { Header, Content, Sider,Footer } = Layout;
const { SubMenu } = Menu;


export class RecommendTopicsView extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapsed: false,
        ...
        return (
            <Layout style={{ minHeight: '100vh' }}>
                <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse}>
                    ...
                    >
                        <SubMenu key="sub1" icon={<FileTextOutlined />} inlineCollapsed={true} title="话题">
                ...
                <Layout className="site-layout" stytle={{backgroundColor:'white'}}>
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                            <RecommendTopics userId={this.state.userId}/>
                        </div>
                    </Content>
